...
function IframeUi() {
    ...
    this.defaultJavascript = '//ajax库采用axios\n' +
        ...
        '// 折线图\n' +
        'var echartslines = document.getElementsByClassName(\'echarts-line\');\n' +
        'if (echartslines && echartslines.length > 0) {\n' +
        '    for (var i = 0; i < echartslines.length; i++) {\n' +
        '        var myChart = echarts.init(echartslines[i]);\n' +
        '        var option = {\n' +
        '            title: {\n' +
        '                text: \'折线图\'\n' +
        '            },\n' +
        ...
        '// 饼图\n' +
        'var echartspies = document.getElementsByClassName(\'echarts-pie\');\n' +
        'if (echartspies && echartspies.length > 0) {\n' +
        '    for (var i = 0; i < echartspies.length; i++) {\n' +
        '        var myChart = echarts.init(echartspies[i]);\n' +
        '        var option = {\n' +
        // '            title: {\n' +
        // '                text: \'饼图\'\n' +
        // '            },\n' +
