...
function Constant(){
    ...
    this.responsiveList = [
        ...
        {id:this.responsive.LG,name:"电脑",width:"1200px",icon:"assets/drag/img/header/pc1.png"},
        {id:this.responsive.XL,name:"大型设备",width:"100%",icon:"assets/drag/img/header/pc1.png",checked:true}
    ]
            ...
            children:[
                {
                    ...
                    html:"<el-row><el-col :span='12'></el-col><el-col :span='12'></el-col></el-row>",
                },
                {
                    name:"后台框架",
            ...
            children:[
                {
                    ...
                    html:"<el-form label-width='100px'><el-form-item label='单行标题'></el-form-item><el-row><el-col :span='12'><el-form-item label='左标题'></el-form-item></el-col><el-col :span='12'><el-form-item label='右标题'></el-form-item></el-col></el-row><el-form-item label='单选'><el-radio-group v-model='radioGroup'><el-radio label='1'>单选项1</el-radio><el-radio label='2'>单选项2</el-radio></el-radio-group></el-form-item><el-form-item label='多选'><el-checkbox-group v-model='checkboxGroup'><el-checkbox label='1'>多选项</el-checkbox></el-checkbox-group></el-form-item><el-form-item ><el-row><el-col :span='12'><el-button>提交</el-button></el-col><el-col :span='12'></el-col></el-row></el-form-item></el-form>"
                },
                {
                    name:"普通条目",
            ...
            children:[
                {
                    ...
                    html:"<el-select value='1' @focus='focus'><el-option label='选择1' value='1'></el-option></el-select>"
                }
                ,
                {
                    name:"单选框",
                ...
                }/*,
                {
                    name:"单选框",
                    icon:"assets/drag/img/left/choice1.png",
                    html:"<el-radio label='1'>单选项</el-radio>",
                },{
                    name:"多选框",
                    icon:"assets/drag/img/left/multiple1.png",
                    html:"<el-checkbox label='1'>多选项</el-checkbox>",
                }*/,{
                    name:"开关",
                    icon:"assets/drag/img/left/onoff1.png",
                    html:"<el-switch v-model='bool' ></el-switch>"
                },
            ]
        },
        {
            ...
            children:[
                {
                    ...
                    html:"<el-date-picker :editable='true' :clearable='true'></el-date-picker>"
                },{
                    name:"文件上传",
                    ...
                    html:"<el-rate></el-rate>"
                },{
                    name:"颜色",
                    icon:"assets/drag/img/left/color1.png",
                    html:"<el-color-picker></el-color-picker>"
                },{
                    name:"标签",
                    ...
                    html:"<el-progress :percentage='50' :show-text='true'></el-progress>"
                },{
                    name:"文字链接",
                ...
                ,{
                    ...
                    html:"<el-input-number></el-input-number>",
                },
                {
                    name:"表格",
                    icon:"assets/drag/img/left/form1.png",
                    html:"<el-table :data='tableList' :fit='true' :show-header='true'><el-table-column prop='id' label='列1' > </el-table-column><el-table-column prop='name' label='列2' > </el-table-column><el-table-column label='操作' fixed='right'><template slot-scope='scope'><el-button>编辑</el-button><el-button>删除</el-button></template></el-table-column></el-table>"
                },{
                    name:"静态表格",
                    icon:"assets/drag/img/left/form1.png",
                ...
                },
                {
                    name:"分页",
                    icon:"assets/drag/img/left/other1.png",
                    html:"<el-pagination layout='prev,pager,next' :total='pageTotal' :page-size='pageSize' :pager-count='pageCount'></el-pagination>"
                },
                {
                    name:"标记",
                ...
                },
                {
                    name:"头像",
                    icon:"assets/drag/img/left/photo1.png",
                    html:"<el-avatar shape='square' :size='100' fit='fit' :src='avatarUrl'></el-badge>"
                },
                /*{
                没造结构 不显示
                    name:"文字提示",
            ...
            children:[
                ...
                },
                {
                    name:"图片",
                    icon:"assets/drag/img/left/photo1.png",
                    html:"<el-image :src='imgSrc' :preview-src-list='imgPreviewSrcList'></el-image>"
                },{
                    name:"图标",
                    icon:"assets/drag/img/left/other1.png",
    ...
    */
    this.tagClassMapping = {
        /*标签名:行为*/
        /*容器*/
        "el-row":           {name:"行",canZoom:true,assistZoom:true,assistDelete:true,assistAdd:true,assistDuplicate:true,       dragInto:true,      duplicate:true,duplicateAttr:[],        copy:true,       paste:false, canDelete:true,onlyChildren:["el-col"],        addOneItems:[{"":[{html:"<el-col :span='12'></el-col>",focus:false}]}]          },
        "el-col":           {name:"列",canZoom:true,assistZoom:true,      dragInto:true,       duplicate:true,duplicateAttr:[],        copy:false,      paste:true,  canDelete:true,assistDelete:true,onlyParents:["el-row"]                                                               },
        "el-container":     {name:"容器",     dragInto:false,       duplicate:true,assistDuplicate:true,duplicateAttr:[],         copy:true,      paste:true,   canDelete:true,assistDelete:true,                                                               },
        ...
        "el-form-item":     {name:"表单条目",canZoom:true,assistZoom:true,treeExtraName:{attr:["label"]},   dragInto:true,      duplicate:true,assistDuplicate:true,duplicateAttr:[],         copy:true,      paste:true,    canDelete:true,assistDelete:true,     onlyParents:["el-form","el-col"], childrenLimit:1  },
        /*表单*/
        "el-button":        {name:"按钮",treeExtraName:{attr:[],text:true},     dragInto:false,     duplicate:true,duplicateAttr:[],         copy:true,      paste:false,   canDelete:true,      },
        ...
        "el-link":          {name:"链接",     dragInto:false,     duplicate:true,duplicateAttr:[],         copy:true,      paste:false,   canDelete:true,      },
        ...
        "el-input":         {name:"输入框",treeExtraName:{attr:["v-model"]},    dragInto:false,     duplicate:true,duplicateAttr:[],         copy:true,      paste:false,   canDelete:true,    bind:{"v-model":''} },
        "el-input-number":  {name:"计数器",treeExtraName:{attr:["v-model"]},    dragInto:false,     duplicate:false,duplicateAttr:[],         copy:false,      paste:false,   canDelete:true,     bind:{"v-model":0},tmpWrapTag:'span'},
        "el-select":        {name:"下拉框",treeExtraName:{attr:["v-model"]},    dragInto:false,     duplicate:true,duplicateAttr:[],         copy:true,      paste:false,   canDelete:true,    onlyChildren:["el-option"], bind:{"v-model":''}, assistAdd:true,addOneItems:[{"":[{html:"<el-option label='选择1' value='1'></el-option>",focus:true}]}]       },
        "el-option":        {name:"下拉框选项",treeExtraName:{attr:["label"]},dragInto:false,      duplicate:true,duplicateAttr:["value"],  copy:false,      paste:false,   canDelete:true,    onlyParents:["el-select"]         },
        ...
        "el-slider":        {name:"滑块",treeExtraName:{attr:["v-model"]},     dragInto:false,     duplicate:true,duplicateAttr:[],          copy:true,      paste:false,  canDelete:true,      bind:{"v-model":0}},
        /*组件*/
        "el-tabs":          {name:"标签页",treeExtraName:{attr:["v-model"]}, dragInto:false,     duplicate:true,assistDuplicate:true,duplicateAttr:[],          copy:true,      paste:false,  canDelete:true,assistDelete:true,    bind:{"v-model":''},assistAdd:true,addOneItems:[{"":[{html:"<el-tab-pane label='新标签' name='third'></el-tab-pane>",focus:true}]}]},
        "el-tab-pane":      {name:"标签子项",treeExtraName:{attr:["label"]},  dragInto:true,      duplicate:true,assistDuplicate:true,duplicateAttr:["name"],    copy:false,     paste:true,   canDelete:true,assistDelete:true,    },
        "el-time-select":   {name:"时间选择器",treeExtraName:{attr:["v-model"]}, dragInto:false,    duplicate:true,                           copy:false,     paste:true,   canDelete:true,    bind:{"v-model":''}},
        "el-date-picker":   {name:"日期选择器",treeExtraName:{attr:["v-model"]}, dragInto:false,    duplicate:true,                           copy:false,     paste:true,   canDelete:true,    bind:{"v-model":''}},
        "el-upload":        {name:"文件上传",treeExtraName:{attr:[":file-list"]},   dragInto:false,    duplicate:true,                           copy:true,      paste:false,  canDelete:true,    bind:{":file-list":[]}    },
        "el-rate":          {name:"评分",treeExtraName:{attr:["v-model"]},      dragInto:false,    duplicate:true,                           copy:true,      paste:false,  canDelete:true,    bind:{"v-model":0}       },
        "el-color-picker":  {name:"颜色选择器",treeExtraName:{attr:["v-model"]}, dragInto:false,    duplicate:true,                           copy:true,      paste:false,  canDelete:true,   bind:{"v-model":''} },
        "el-tag":           {name:"标签",      dragInto:false,    duplicate:true,                           copy:true,      paste:false,  canDelete:true,    },
        "el-progress":      {name:"进度条",     dragInto:false,    duplicate:true,                           copy:true,      paste:false,  canDelete:true,    },
        "el-table":         {name:"表格容器",treeExtraName:{attr:[":data"]},   dragInto:false,    duplicate:true,                           copy:true,      paste:false,  canDelete:true,  bind:{":data":[{}]},  onlyChildren:["el-table-column"],assistAdd:true,addOneItems:[{"":[{html:"<el-table-column label='列' width='180'></el-table-column>",focus:true}]}]             },
        "el-table-column":  {name:"表格列",treeExtraName:{attr:["label"]},    dragInto:false,    duplicate:true,                           copy:false,      paste:false,  canDelete:true,  onlyParents:["el-table"] },
        "el-transfer":      {name:"穿梭框",treeExtraName:{attr:["v-model"]},   dragInto:false,    duplicate:true,                           copy:true,      paste:false,  canDelete:true,    bind:{"v-model":'',":data":[]}    },
        "el-card":          {name:"卡片",canZoom:true,assistZoom:true,treeExtraName:{attr:["header"]},   dragInto:true,    duplicate:true,assistDuplicate:true,                           copy:true,      paste:true,assistDelete:true,  canDelete:true    },
        "el-carousel":      {name:"走马灯",                                  dragInto:false,    duplicate:true,assistDuplicate:true,                           copy:true,      paste:true,  canDelete:true,assistDelete:true,onlyChildren:["el-carousel-item"],assistAdd:true,addOneItems:[{"":[{html:"<el-carousel-item></el-carousel-item>",focus:false}]}]    },
        "el-carousel-item": {name:"走马灯条目",treeExtraName:{attr:["label"]},                          dragInto:true,    duplicate:true,assistDuplicate:true,                           copy:false,      paste:true,  canDelete:true,assistDelete:true,onlyParents:["el-carousel"]    },
        "el-image":         {name:"图片",treeExtraName:{attr:[":src"]}, dragInto:false,    duplicate:true,                           copy:true,      paste:false,  canDelete:true ,bind:{":src":'img.jpg',':preview-src-list':['img.jpg']}    },
        ...
        "el-submenu":       {name:"子菜单", dragInto:false,    duplicate:true,duplicateAttr:["index"],   copy:true,      paste:true,  canDelete:true ,onlyParents:["el-menu","el-submenu"],onlyChildren:["el-menu","el-menu-item"],assistAdd:true,addOneItems:[{"":[{html:"<el-menu-item index='2-1'>新菜单条目</el-menu-item>",focus:false}]}]    },
        ...
        "el-breadcrumb":    {name:"面包屑",dragInto:false,  duplicate:true,   copy:true,      paste:false,  canDelete:true ,onlyChildren:["el-breadcrumb-item"],assistAdd:true,addOneItems:[{"":[{html:"<el-breadcrumb-item >新条目</el-breadcrumb-item>",focus:false}]}]    },
        "el-breadcrumb-item":{name:"面包屑条目",dragInto:false,  duplicate:true,   copy:true,      paste:false,  canDelete:true ,onlyParents:["el-breadcrumb"]    },
        "el-page-header":   {name:"页头",dragInto:false,  duplicate:true,   copy:true,      paste:false,  canDelete:true    },
        "el-steps":         {name:"步骤",dragInto:true,  duplicate:true,   copy:true,      paste:false,  canDelete:true,onlyChildren:["el-step"],assistAdd:true,addOneItems:[{"":[{html:"<el-step title='新步骤'></el-step>",focus:false}]}], bind:{":active":0},    },
        "el-step":          {name:"步骤条目",dragInto:false,  duplicate:true,   copy:true,      paste:false,  canDelete:true,onlyParents:["el-steps"]    },
        "el-collapse":      {name:"折叠面板",treeExtraName:{attr:["v-model"]},dragInto:true,  duplicate:true,   copy:true,      paste:false,  canDelete:true,onlyChildren:["el-collapse-item"],assistAdd:true,addOneItems:[{"":[{html:"<el-collapse-item title='折叠条目' name='1'></el-collapse-item>",focus:false}]}], bind:{"v-model":[]},    },
        "el-collapse-item": {name:"折叠条目",treeExtraName:{attr:["title"]},dragInto:true,  duplicate:true,duplicateAttr:["name"],   copy:true,      paste:false,  canDelete:true,onlyParents:["el-collapse"]   },
        "el-pagination":    {name:"分页",dragInto:false,  duplicate:false,   copy:true,      paste:false,  canDelete:true,bind:{':total':1000,':page-size':10,':pager-count':8}},
        "el-badge":         {name:"标记",treeExtraName:{attr:[":value"]},dragInto:true,  duplicate:true,   copy:true,      paste:true,  canDelete:true,bind:{':value':'10'}},
        "el-avatar":        {name:"头像",treeExtraName:{attr:[":src"]},dragInto:false,  duplicate:true,   copy:true,      paste:true,  canDelete:true,bind:{':src':'img.jpg'}},
        "el-tooltip":       {name:"提示箱",dragInto:true,  duplicate:true,   copy:true,      paste:true,  canDelete:true},
        "el-calendar":      {name:"日历",treeExtraName:{attr:["v-model"]},dragInto:false,  duplicate:true,   copy:true,      paste:true,  canDelete:true,bind:{'v-model':new Date()}},
        ...
        [
            {
                ...
                content:{
                    ...
                    "el-date-picker":[
                        {type:this.type.SELECT          ,clearAttr:true     ,oneLine:true     ,change:this.change.ATTR     ,title:'显示类型'    ,attrName:'type'    ,options:[{"year":"年"},{"month":"月"},{"date":"日期"},{"dates":"dates"},{"week":"周"},{"datetime":"日期时间"},{"datetimerange":"日期时间范围"},{"daterange":"日期范围"},{"monthrange":"月范围"}]},
                        {type:this.type.CHECKBOX        ,clearAttr:true     ,oneLine:true     ,change:this.change.ATTR     ,title:'状态'    ,options:[{"c":true,"n":"readonly","t":"完全只读","u":false},{"c":true,"n":"disabled","t":"禁用","u":false},{"c":"true","n":":editable","t":"文本框可输入","u":"false"},{"c":"true","n":":clearable","t":"是否显示清除按钮","u":"false"}]},
